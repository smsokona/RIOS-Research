...
The visuals above give us an idea of what words are used most frequently and how that has changed over time. We can definitely see what people view as inclusive teaching has changed but still varies. 
...
## The Most Distinctive Words By Year {.tabset}
...
The graph below is the same as the ones above, with all of the Years on one grpah for compariosn, however, some of the weights are higher for Years 2016, 2017, and 2018, however that's not present above...
...
[source1]: https://www.tidytextmining.com/tfidf.html
