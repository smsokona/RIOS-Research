...
The tables and visuals above give us an idea of how often are DEI Words used and what does that say about inclusivity of the articles. However, looking at the most commonly used DEI words doens't give us all the information on how the article is being inclusive.

## In Depth Bar Chart of Word Count By Year {.tabset}

This is a bar chart that looks more indepth into the frequency of words being used, each year. You can click on each tab to see to compare by each year.
